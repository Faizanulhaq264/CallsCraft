...
MeetingServiceEventListener::MeetingServiceEventListener(void (*onMeetingStarts)(), 
                                                       void (*onMeetingEnds)(), 
                                                       ...
                                                       MeetingParticipantsCtrlEventListener* participantsListener)
{
	...
	participantsListener_ = participantsListener;
}
...
void MeetingServiceEventListener::onMeetingStatusChanged(MeetingStatus status, int iResult)
{
	...
	case MEETING_STATUS_INMEETING:
		...
		if (participantsListener_) {
			participantsListener_->scanExistingParticipants();
		}
